...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("{color=#000000}Back{/color}") action Rollback()
            textbutton _("{color=#000000}History{/color}") action ShowMenu('history')
            textbutton _("{color=#000000}Skip{/color}") action Skip() alternate Skip(fast=True, confirm=True)
            textbutton _("{color=#000000}Auto{/color}") action Preference("auto-forward", "toggle")
            textbutton _("{color=#000000}Save{/color}") action ShowMenu('save')
            textbutton _("{color=#000000}Q.Save{/color}") action QuickSave()
            textbutton _("{color=#000000}Q.Load{/color}") action QuickLoad()
            textbutton _("{color=#000000}Prefs{/color}") action ShowMenu('preferences')
